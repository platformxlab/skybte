...
void heap_create(bytefs_heap *heap, int capacity) {
  ...
  heap->key = (int64_t *) malloc(capacity * sizeof(int64_t));
  memset(heap->key, 0, capacity * sizeof(int64_t));
  heap->storage = (void **) malloc(capacity * sizeof(void *));
  memset(heap->storage, 0, capacity * sizeof(void *));
