...
## DEBUG build
if flags['debug'] == '1':
  env['CPPFLAGS'] = '-g -std=c++17 -g3 -pthread %s' % warn_flags
## GPROF build
elif flags['gprof'] == '1':
...
## OPT build
  ...
  env['CPPFLAGS'] = '-std=c++17 -O3 -g -pthread -funroll-loops -lstdc++fs -D_FILE_OFFSET_BITS=64 %s' % warn_flags
  env['CPPDEFINES'].append('NO_DEBUG')
...
macsim_src = [
  ...
  'src/mmu.cc',
  'src/tlb.cc',
  'src/SkyByte-Sim/backend.cc',
  'src/SkyByte-Sim/bytefs_gc.cc',
  'src/SkyByte-Sim/bytefs_heap.cc',
  'src/SkyByte-Sim/bytefs_utils.cc',
  'src/SkyByte-Sim/cache_controller.cc',
  'src/SkyByte-Sim/cache.cc',
  'src/SkyByte-Sim/cpu_scheduler.cc',
  'src/SkyByte-Sim/ftl.cc',
  'src/SkyByte-Sim/simulator_clock.cc',
  'src/SkyByte-Sim/ssd_stat.cc',
  'src/SkyByte-Sim/trace_utils.cc',
  'src/SkyByte-Sim/utils.cc',
  'src/main.cc'
]
